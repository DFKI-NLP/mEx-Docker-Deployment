...
if __name__ == '__main__':
    tokens = ['Die', 'Patientin', 'fuehlt', 'sich', 'gut.', 'Klagt', 'keine', 'aktuellen', 'Beschwerden', 'In', 'der', 'Zwischenkontrolle', 'weiter', 'gutes', 'Crea.Urbason', 'auf', '16', 'mg', 'reduziert.', 'Heute', 'Spiegelkontrolle.', 'Keine', 'Oedeme,', 'keine', 'Dysurie.', 'kein', 'Fieber.', 'keine', 'Schmerzen', 'am', 'Tx,', 'Leichte', 'Gewichtzunahme.', 'Guter', 'Appetit.', 'RR', 'weiterhin', 'hoch', 'daher', 'jetzt', 'zusaetzlich', 'Norvasc', 'verordnet.', 'Sandimmuinspiegel', 'im', 'therapeutischen', 'Bereich.', 'Keine', 'Aenderung', 'der', 'Medikation.']
    tags = ['O', 'B-Person', 'O', 'O', 'B-State_of_health', 'O', 'O', 'O', 'B-Medical_condition', 'O', 'O', 'B-DiagLab_Procedure', 'O', 'B-State_of_health', 'B-Medication', 'O', 'B-Dosing', 'I-Dosing', 'B-Treatment', 'O', 'B-DiagLab_Procedure', 'O', 'B-Medical_condition', 'O', 'B-Medical_condition', 'O', 'B-Medical_condition', 'O', 'B-Medical_condition', 'O', 'B-Body_part', 'B-Measurement', 'B-Process', 'B-State_of_health', 'B-Process', 'B-Process', 'O', 'O', 'O', 'O', 'O', 'B-Medication', 'O', 'B-Biological_chemistry', 'B-State_of_health', 'I-State_of_health', 'I-State_of_health', 'O', 'B-Treatment', 'I-Treatment', 'I-Treatment']
    obj = RelationExtractionModel()
    c = obj.predict(tokens, [21, 43], tags)
